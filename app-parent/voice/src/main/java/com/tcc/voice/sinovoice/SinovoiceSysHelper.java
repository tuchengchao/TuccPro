...
public class SinovoiceSysHelper {
	...
	private static SinovoiceSysHelper mInstance;

	private SinovoiceSysHelper() {
	}

	public static SinovoiceSysHelper getInstance() {
		if (mInstance == null) {
			mInstance = new SinovoiceSysHelper();
		}
		return mInstance;
	}
